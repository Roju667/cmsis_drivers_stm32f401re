 ...
 * <5>   - SCO : Start of conversion. The value of this bit stays “1” during
 * conversion, and is reset to “0” after conversion is complete <7:6> - OSS :
 * Controls the oversampling ratio of the pressure measurement
 */
...
typedef enum
{
	ULTRA_LOW_PWR_MODE = 0, STANDARD_MODE, HIGH, ULTRA_HIGH_RESOLUTION
} oss_ratio_t;
 ...
 * 			   Oss (register F4h <7:6>): controls the oversampling
 * ratio of the pressure measurement (00b: single, 01b: 2 times, 10b: 4 times,
 * 11b: 8 times).
 * @param[in] - None.
 * @return    - None.
 */
